...
// Detail Modal Component - moved outside to prevent recreation on every render
const DetailModal = ({ selectedOperation, handleCloseDetail }) => (
...
export default function OperationBreakdown() {
  ...
  const [sortConfig] = useState({ key: 'style', direction: 'asc' })
